...
if ($_POST['save'] && $module_id) {
    ...
    if ($strError)
        ...
        LocalRedirect('/bitrix/admin/likee.mpbuilder_step3.php?module_id=' . $module_id . '&lang=' . LANGUAGE_ID);
                        ...
                        <tr>
                            <td colspan=2>
                                <label><input type=checkbox
                                              name="work[<?= htmlspecialchars($file) ?>]" <?= $_POST['save'] && !$_REQUEST['work'][$file] ? '' : 'checked' ?>> <?= htmlspecialchars($file) ?>
                                </label>
                            </td>
